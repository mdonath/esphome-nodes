...
namespace esphome
{
  namespace max7219matrix
  {
    ...
    class MAX7219MatrixPagesComponent;

    using max7219_matrix_pages_writer_t = std::function<void(MAX7219MatrixPagesComponent &)>;

    class MAX7219MatrixPagesComponent : public PollingComponent,
                                        public display::DisplayBuffer,
                                        public spi::SPIDevice<spi::BIT_ORDER_MSB_FIRST, spi::CLOCK_POLARITY_LOW,
                                                   spi::CLOCK_PHASE_LEADING, spi::DATA_RATE_1MHZ>
    {
    public:
      void set_writer(max7219_matrix_pages_writer_t &&writer) { this->writer_local_ = writer; };
    ...
    protected:
      ...
      optional<max7219_matrix_pages_writer_t> writer_local_{};
    };
